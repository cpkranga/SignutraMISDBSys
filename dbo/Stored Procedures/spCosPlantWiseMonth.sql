...
create procedure [dbo].[spCosPlantWiseMonth]
--exec [spCosPlantWiseMonth] 'P',2020
(
	@SalesType varchar(1),
	--@Month int ,
	@Year int
...
insert into #temp1
select a.PlantCode --,isnull(f.CustomerName,'#Others') as CustomerName
...
group by a.PlantCode  --,isnull(f.CustomerName,'#Others')
...
select f.PlantName,#temp1.* 

from #temp1 
left outer join CosPlantMst as f on f.PlantCode=#temp1.PlantCode
