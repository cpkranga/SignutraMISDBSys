...
CREATE procedure [dbo].[spCosDashboardGroupWise]
--exec [spCosDashboardGroupWise] 'P',7,2020
(
	@SalesType varchar(1),
	@Month int ,
	@Year int
...
insert into #temp1
select d.RptDivisionCode,i.GroupCode,isnull(e.GroupName,'#Others') as GroupName
...
left outer join CosMaterialGroupMst as i on i.GroupCode=c.GroupCode
...
group by d.RptDivisionCode,i.GroupCode,isnull(e.GroupName,'#Others')
