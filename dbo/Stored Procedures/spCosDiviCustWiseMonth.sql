...
create procedure [dbo].spCosDiviCustWiseMonth
--exec [spCosDiviCustWiseMonth] 'P',2020
(
	@SalesType varchar(1),
	--@Month int ,
	@Year int
...
insert into #temp1
select d.RptDivisionCode,i.CustomerNo as CustomerNo --,isnull(f.CustomerName,'#Others') as CustomerName
...
group by d.RptDivisionCode,i.CustomerNo  --,isnull(f.CustomerName,'#Others')
