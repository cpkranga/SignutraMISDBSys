...
CREATE procedure [dbo].spCosDiviChannelWiseMonth
--exec [spCosDiviChannelWiseMonth] 'P',2020
(
	@SalesType varchar(1),
	--@Month int ,
	@Year int
...
insert into #temp1
select d.RptDivisionCode,i.RptCustomerNo as CustomerNo --,isnull(f.CustomerName,'#Others') as CustomerName
...
group by d.RptDivisionCode,i.RptCustomerNo  --,isnull(f.CustomerName,'#Others')
