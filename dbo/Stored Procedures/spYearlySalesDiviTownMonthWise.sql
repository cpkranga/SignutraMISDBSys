CREATE procedure [dbo].[spYearlySalesDiviTownMonthWise]
...
,f.ReagionId,g.ReagionName 
,e.AreaId,f.AreaName 
,d.MainTownId,e.MainTownName 
,a.TownId,a.DistTownCode,d.TownName 
...
,d.MainTownId,e.MainTownName 
,a.TownId,a.DistTownCode,d.TownName 
order by f.ReagionId
,e.AreaId,f.AreaName 
,d.MainTownId,e.MainTownName 
,a.DistTownCode,d.TownName 