...
CREATE procedure [dbo].[spCosActCustSkuMonthWise]
--exec [spCosActCustSkuMonthWise] 'P',2016
(
	@SalesType varchar(1),
	--@Month int ,
	@Year int
...
insert into #temp1
select a.CustomerNo as CustomerNo,k.GroupCode,k.GroupName,c.CatCode,j.CatName,c.MaterialCode,c.MaterialName
...
group by a.CustomerNo,k.GroupCode,k.GroupName,
...
select f.CustomerName as CustomerName
,f.TypeNo,g.TypeName
,#temp1.* 
...
left outer join CosCustomerTypeMst as g on g.TypeNo=f.TypeNo
