CREATE procedure [dbo].[spYearlySalesCatSMMonthWise]
...
select c.CatCode,j.CatName  
,a.SalesManId,h.UserName as SalesManName
,sum(isnull((case when month(a.SalesFromDate)=1 then (a.NetTotQty * c.UnitFactor)  end),'0')) as 'JanNetQty'
,sum(isnull((case when month(a.SalesFromDate)=1 then a.NetTotValues end),'0')) as 'JanNetVal'
,sum(isnull((case when month(a.SalesFromDate)=2 then (a.NetTotQty * c.UnitFactor) end),'0')) as 'FebNetQty'
,sum(isnull((case when month(a.SalesFromDate)=2 then a.NetTotValues end),'0')) as 'FebNetVal'
,sum(isnull((case when month(a.SalesFromDate)=3 then (a.NetTotQty * c.UnitFactor) end),'0')) as 'MarNetQty'
,sum(isnull((case when month(a.SalesFromDate)=3 then a.NetTotValues end),'0')) as 'MarNetVal'
,sum(isnull((case when month(a.SalesFromDate)=4 then (a.NetTotQty * c.UnitFactor) end),'0')) as 'AprNetQty'
,sum(isnull((case when month(a.SalesFromDate)=4 then a.NetTotValues end),'0')) as 'AprNetVal'
,sum(isnull((case when month(a.SalesFromDate)=5 then (a.NetTotQty * c.UnitFactor) end),'0')) as 'MayNetQty'
,sum(isnull((case when month(a.SalesFromDate)=5 then a.NetTotValues end),'0')) as 'MayNetVal'
,sum(isnull((case when month(a.SalesFromDate)=6 then (a.NetTotQty * c.UnitFactor) end),'0')) as 'JunNetQty'
,sum(isnull((case when month(a.SalesFromDate)=6 then a.NetTotValues end),'0')) as 'JunNetVal'
,sum(isnull((case when month(a.SalesFromDate)=7 then (a.NetTotQty * c.UnitFactor) end),'0')) as 'JulNetQty'
,sum(isnull((case when month(a.SalesFromDate)=7 then a.NetTotValues end),'0')) as 'JulNetVal'
,sum(isnull((case when month(a.SalesFromDate)=8 then (a.NetTotQty * c.UnitFactor) end),'0')) as 'AugNetQty'
,sum(isnull((case when month(a.SalesFromDate)=8 then a.NetTotValues end),'0')) as 'AugNetVal'
,sum(isnull((case when month(a.SalesFromDate)=9 then (a.NetTotQty * c.UnitFactor) end),'0')) as 'SepNetQty'
,sum(isnull((case when month(a.SalesFromDate)=9 then a.NetTotValues end),'0')) as 'SepNetVal'
,sum(isnull((case when month(a.SalesFromDate)=10 then (a.NetTotQty * c.UnitFactor) end),'0')) as 'OctNetQty'
,sum(isnull((case when month(a.SalesFromDate)=10 then a.NetTotValues end),'0')) as 'OctNetVal'
,sum(isnull((case when month(a.SalesFromDate)=11 then (a.NetTotQty * c.UnitFactor) end),'0')) as 'NovNetQty'
,sum(isnull((case when month(a.SalesFromDate)=11 then a.NetTotValues end),'0')) as 'NovNetVal'
,sum(isnull((case when month(a.SalesFromDate)=12 then (a.NetTotQty * c.UnitFactor) end),'0')) as 'DecNetQty'
