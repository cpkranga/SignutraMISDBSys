CREATE procedure [dbo].[spYearlySalesSKUMonthWise]
--exec spYearlySalesSKUMonthWise 1,2019
(
	@Distributor int,
	@Year int
...
as
select c.BrandCode,i.BrandName,c.ProductCode,c.ProductName
...
,sum(a.NetTotQty * c.UnitFactor ) as 'YTDNetTotQty(400g)',sum(a.NetTotValues) as YTDNetTotValues
...
group by c.BrandCode,i.BrandName,c.ProductCode,c.ProductName,c.UnitCode   
