CREATE procedure [dbo].[spYearlySalesHqBrandSKUWise]
--exec [spYearlySalesHqBrandSKUWise] 1,2020
(
	@Distributor int,
	@Year int
...
select a.SalesManId as HqId,h.UserName as HQName
,c.BrandCode,i.BrandName 
,a.ProductId,c.ProductName 
