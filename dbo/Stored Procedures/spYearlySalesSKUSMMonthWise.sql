CREATE procedure [dbo].[spYearlySalesSKUSMMonthWise]
--exec [spYearlySalesSKUSMMonthWise] 1,2019
(
	@Distributor int,
	@Year int
...
as
select c.ProductCode,c.ProductName,c.UnitCode 
...
group by c.ProductCode,c.ProductName,c.UnitCode
